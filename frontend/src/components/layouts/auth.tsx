...
export const AuthLayout: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <Layout>
      ...
      <div
        className='top-0 bottom-0 hidden lg:flex flex-wrap z-0 h-screen w-screen overflow-x-hidden overflow-y-hidden'>
        {recommendProjects &&
      ...
      <div
        className='absolute top-0 min-h-screen lg:h-screen w-screen lg:grid lg:grid-cols-2 lg:bg-black lg:bg-opacity-70 z-10'>
        <div
          className='col-span-1 h-full w-full bg-transparent text-white text-center flex-col justify-center hidden lg:flex'>
          <LogoWhite className='mx-auto h-20 object-fill text-white' />
        </div>

        <div
          className='py-8 lg:col-span-1 min-h-screen w-full px-4 lg:px-0 lg:mx-auto bg-transparent relative flex flex-col justify-center'>
          <div className='mb-8 w-full flex justify-center lg:hidden'>
            <Logo className='w-16 object-fill lg:ml-8' />
          </div>

          <div
            className='h-full lg:h-auto w-full lg:max-w-xl lg:mx-auto flex flex-col justify-center lg:p-16 bg-white rounded-lg'>
